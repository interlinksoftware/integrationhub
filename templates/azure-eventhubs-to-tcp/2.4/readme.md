...
# Azure EventHubs to TCP Listener (azure-eventhubs-to-tcp v2.4)
...
- The template is installed and is available within the user interface. Install directly from github or transfer the template to your Integration Hub server.
  ...
  - Installing directly from Github:
    ...
    ```
    ih-cli template import https://raw.githubusercontent.com/interlinksoftware/integrationhub/main/templates/azure-eventhubs-to-tcp/<version>/readme.md
    ```
...
<img src="../../../assets/images/azure-eventhubs-to-tcp/2.4/create-pipeline-source.jpg" width="650" />
