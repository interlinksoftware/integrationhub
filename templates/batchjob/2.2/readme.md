...
# Batchjob (batchjob v2.2)

**Important:** _These instructions assume you have Integration Hub v2.3+ installed_

- For help installing [Integration Hub](https://docs.interlinksoftware.com/ih/latest/index.html), see the [Installation Guide](https://docs.interlinksoftware.com/ih/latest/install/install_overview.html).

## What's new in batchjob v2.2

| Enhancement, Fix or Feature                                                                                                                                                                                                                                                                           | ID      |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------ |
| Remove deprecated `startDelayedSeconds` and `triggerStartDelay` properties for the quartz component configuration                                                                                                                                                                                     | IH-726  |
| Handle scenarios where `args` are empty<br/><br/>The bump from Camel V3 -> V4 changed how they execute external scripts to make things more strict, resulting in empty args being passed as a literal '', resulting in `got an unexpected argument ''` errors in our pre-packaged batch job pipelines | IH-1012 |
...
- The template is installed and is available within the user interface. Install directly from github or transfer the template to your Integration Hub server.
  - Installing directly from Github:
    ...
    ```
    ih-cli template import https://raw.githubusercontent.com/interlinksoftware/integrationhub/main/templates/batchjob/2.2/readme.md
    ```
