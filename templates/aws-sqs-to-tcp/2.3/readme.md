...
- An [Output Target](https://github.com/interlinksoftware/integrationhub/tree/main/templates/aws-sqs-to-tcp#defining-an-output-target), defining the destination for the processed data.
...
- The template is installed and is available within the user interface. Install directly from github or transfer the template to your Integration Hub server.
  ...
  - Installing directly from Github:
    ...
    ```
    ih-cli template import https://raw.githubusercontent.com/interlinksoftware/integrationhub/main/templates/aws-sqs-to-tcp/2.3/aws-sqs-to-tcp~2.3.yml
    ```
...
<img src="../../../assets/images/aws-sqs-to-tcp/2.3/create_pipeline.png" width="650" />
...
| `Proxy Host`                        | The Hostname / IP address of the proxy server                                                                                             |
| `Proxy Port`                        | The port that the proxy server is listening on                                                                                              |
