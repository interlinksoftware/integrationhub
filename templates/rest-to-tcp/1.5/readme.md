...
# REST to TCP Listener (rest-to-tcp v1.5)

**Important:** _These instructions assume you have Integration Hub v2.5.1+ installed_

- For help installing [Integration Hub](https://docs.interlinksoftware.com/ih/latest/index.html), see the [Installation Guide](https://docs.interlinksoftware.com/ih/latest/install/install_overview.html).

## What's new in rest-to-tcp v1.5

| Enhancement or Feature                                                                                                                                                  | ID      |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------ |
| Extend logic to support followRedirects. This is to address scenarios where REST endpoints would hit a HTTP redirect and not follow it, resulting in unexpected results | IH-1033 |
...
- The template is installed and is available within the user interface. Install directly from github or transfer the template to your Integration Hub server.
  - Installing directly from Github:
    ...
    ```
    ih-cli template import https://raw.githubusercontent.com/interlinksoftware/integrationhub/main/templates/rest-to-tcp/1.5/rest-to-tcp~1.5.yml
    ```
...
<img src="../../../assets/images/rest-to-tcp/1.5/create_pipeline.png" width="800" />
...
| `Follow Redirects`        | Follow HTTP redirects returned by the REST endpoint, such as [`301, 302, 307, or 308`]. Keep this enabled when the configured endpoint URL redirects to another location.<br/><br/>Default: `true` (**Enabled**) |
