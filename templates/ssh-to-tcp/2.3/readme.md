...
# SSH to TCP Listener (ssh-to-tcp v2.3)
...
- The template is installed and is available within the user interface. Install directly from github or transfer the template to your Integration Hub server.
  ...
  - Installing directly from Github:
    ...
    ```
    ih-cli template import https://raw.githubusercontent.com/interlinksoftware/integrationhub/main/templates/ssh-to-tcp/2.3/ssh-to-tcp~2.3.yml
    ```
...
<img src="../../../assets/images/ssh-to-tcp/2.3/create_pipeline.jpg" width="800" />
...
<details>
<summary>Tokenize Example</summary>
