...
# RabbitMQ to TCP Listener (rabbitmq-to-tcp v1.4)
...
- The template is installed and is available within the user interface. Install directly from github or transfer the template to your Integration Hub server.
  ...
  - Installing directly from Github:
    ...
    ```
    ih-cli template import https://raw.githubusercontent.com/interlinksoftware/integrationhub/main/templates/rabbitmq-to-tcp/1.4/rabbitmq-to-tcp~1.4.yml
    ```
...
<img src="../../../assets/images/rabbitmq-to-tcp/1.4/create_pipeline.jpg" width="800" />
...
To change this behavior, expand `Authentication (Optional)`. This will allow you to set your own credentials:
